...
class GFXfont:
    ...
    def generate_header(self) -> str:
        ...
        code += "\n"
        code += "#ifdef SHAPOFONT_INCLUDE_AVR_PGMSPACE\n"
        code += "#include <avr/pgmspace.h>\n"
        code += "#endif\n"
        code += "\n"
        code += "#ifdef SHAPOFONT_INCLUDE_GFXFONT\n"
        code += "#include <gfxfont.h>\n"
        code += "#endif\n"
        code += "\n"
        code += "#ifndef SHAPOFONT_PROGMEM\n"
        code += "#ifdef PROGMEM\n"
        code += "#define SHAPOFONT_PROGMEM PROGMEM\n"
        code += "#else\n"
        code += "#define SHAPOFONT_PROGMEM\n"
        code += "#endif\n"
        code += "#define SHAPOFONT_PROGMEM_SELF_DEFINED\n"
        code += "#endif\n"
        code += "\n"
        code += "#ifndef SHAPOFONT_GFXFONT_NAMESPACE\n"
        code += "#define SHAPOFONT_GFXFONT_NAMESPACE\n"
        code += "#define SHAPOFONT_GFXFONT_NAMESPACE_SELF_DEFINED\n"
        code += "#endif\n"
        code += "\n"
        code += f"const uint8_t {self.name}Bitmaps[] SHAPOFONT_PROGMEM = {{\n"
        cols = 16
        ...
        code += f"const SHAPOFONT_GFXFONT_NAMESPACE GFXglyph {self.name}Glyphs[] SHAPOFONT_PROGMEM = {{\n"
        for glyph in self.glyphs:
            code += f"  {glyph.generate_struct_initializer()},\n"
        code += "};\n\n"

        code += f"const SHAPOFONT_GFXFONT_NAMESPACE GFXfont {self.name} SHAPOFONT_PROGMEM = {{\n"
        ...
        code += "};\n"
        code += "\n"
        code += "#ifdef SHAPOFONT_PROGMEM_SELF_DEFINED\n"
        code += "#undef SHAPOFONT_PROGMEM\n"
        code += "#endif\n"
        code += "\n"
        code += "#ifdef SHAPOFONT_GFXFONT_NAMESPACE_SELF_DEFINED\n"
        code += "#undef SHAPOFONT_GFXFONT_NAMESPACE\n"
        code += "#endif\n"
